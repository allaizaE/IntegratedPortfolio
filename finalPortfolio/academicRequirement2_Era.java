...
public class academicRequirement2_Era {

	 JFrame academicRequirement2F;
	 ...
	 */
	public academicRequirement2_Era() {
		initialize();
	}
	...
	private void initialize() {
		...
		academicRequirement2F = new JFrame();
		academicRequirement2F.setBounds(100, 100, 1100, 730);
		academicRequirement2F.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		...
		//This section contains all the buttons for the menu bar. JLabel is used instead of JButton to provide more neat interface. 
			...
			homeClick.addMouseListener(new MouseAdapter() {
				...
				public void mouseClicked(MouseEvent e) {
					...
					academicRequirement2F.dispose();
					
				}
			});
			academicRequirement2F.getContentPane().setLayout(null);
			homeClick.setBounds(336, 48, 59, 21);
			academicRequirement2F.getContentPane().add(homeClick);
			...
			academicRequirement2F.getContentPane().add(aboutLabel);
			...
			academicRequirement2F.getContentPane().add(workLabel1);
			...
			academicRequirement2F.getContentPane().add(resumeClick);
			...
			academicRequirement2F.getContentPane().add(contactClick);
		...
		//Button for paths.
			...
			academicRequirement2F.getContentPane().add(myWorkPath);
			...
			academicRequirement2F.getContentPane().add(graphicPath);
			...
			academicRequirement2F.getContentPane().add(acadPath);
		...
		//Next Button to proceed to the next acadRequirement.
			...
			nextButton.setBounds(930, 236, 82, 41);
			academicRequirement2F.getContentPane().add(nextButton);
		...
		previousButton.setBounds(835, 236, 82, 41);
		academicRequirement2F.getContentPane().add(previousButton);
		
		
		
		//Insert the image label.
		JLabel academicRequirement2BG = new JLabel("");
		academicRequirement2BG.setIcon(new ImageIcon(academicRequirement2_Era.class.getResource("/allaiza_images/academicRequirements2.png")));
		academicRequirement2BG.setBounds(0, 0, 1084, 691);
		academicRequirement2F.getContentPane().add(academicRequirement2BG);
	}
